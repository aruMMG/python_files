...
def metrics(json_path, split_class_path, target_path):
...
def RCNNmetrics(pred_path, target_path):
    true_boxes = []
    pred_boxes = []
    for target_txt in glob.glob(target_path):
        ...
        name_only = os.path.splitext(target_name)[0]
        # print(name_only)
        pred_txt = os.path.join(pred_path, target_name)
        ...
        with open(pred_txt) as f:
            for cnt, line in enumerate(f):
                c,score,x1,y1,x2,x2 = map(float, line.split())
                pred_lis_for_sample = []
                pred_lis_for_sample.append(name_only)
                pred_lis_for_sample.append(0)
                pred_lis_for_sample.append(score)
                pred_lis_for_sample.append(x1)
                pred_lis_for_sample.append(y1)
                pred_lis_for_sample.append(x2)
                pred_lis_for_sample.append(y2)
                pred_boxes.append(pred_lis_for_sample)
        # print(pred_boxes, true_boxes)
    iouvs = np.linspace(0.5,0.95,10)
    mAP = []
...
# mAP.append(mAP5)
#====================
json_path = "/home/sakuni/phd/results/p2/test/all/10_real/10_real/10_real_fold1"
...
json_path = "/home/sakuni/phd/results/p2/test/all/10_real/10_real/10_real_fold2"
...
json_path = "/home/sakuni/phd/results/p2/test/all/10_real/10_real/10_real_fold3"
...
json_path = "/home/sakuni/phd/results/p2/test/all/10_real/10_real/10_real_fold4"
...
json_path = "/home/sakuni/phd/results/p2/test/all/10_real/10_real/10_real_fold5"
...
iouvs.append("mAP")
with open(os.path.join(Path(json_path).parent, "resultsAP.csv"), mode='w') as ap_file:
