...
def mainOnly(path_labels, pred_path, save_dir):
    cms = []
    confs = [0.1,0.15,0.20,0.25,0.30,0.35,0.40,0.45,0.50,0.55,0.60,0.65,0.70,0.75]
    for con in confs:
        cm = []
        confusion_matrix = ConfusionMatrix(nc=1,conf=con)
        ...
        cms.append(cm)
    with open(os.path.join(save_dir, "CM.csv"), mode='w') as ap_file:
        ap_writer = csv.writer(ap_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        ap_writer.writerows(cms)
...
def mainSafe(path_labels, pred_path, safe_pred_path, save_dir):
    confs = [0.1,0.15,0.20,0.25,0.30,0.35,0.40,0.45,0.50,0.55,0.60,0.65,0.70,0.75]
    for con in confs:    
...
if __name__=="__main__":
    ...
    pred_path = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold1/labels"
    safe_pred_path = "/home/aru/phd/objective1/hdr/dataset/lc4/results/wardHistAdj/detect/safe_lc4_wardHistAdj_001_1/labels/*.txt"
    save_dir = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold1"
    mainOnly(path_labels, pred_path, save_dir)
    mainSafe(path_labels, pred_path, safe_pred_path, save_dir)
    
    path_labels = "/home/sakuni/phd/objective2/dataset/real_folds/fold2/labels/val/*.txt"
    pred_path = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold2/labels"
    safe_pred_path = "/home/sakuni/phd/dataset_paper/final_collection25-2/lc4/results/wardHistAdj/detect/safe_lc4_wardHistAdj_001_2/labels/*.txt"
    save_dir = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold2"
    mainOnly(path_labels, pred_path, save_dir)
    mainSafe(path_labels, pred_path, safe_pred_path, save_dir)

    path_labels = "/home/sakuni/phd/objective2/dataset/real_folds/fold3/labels/val/*.txt"
    pred_path = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold3/labels"
    safe_pred_path = "/home/sakuni/phd/dataset_paper/final_collection25-2/lc4/results/wardHistAdj/detect/safe_lc4_wardHistAdj_001_3/labels/*.txt"
    save_dir = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold3"
    mainOnly(path_labels, pred_path, save_dir)
    mainSafe(path_labels, pred_path, safe_pred_path, save_dir)

    path_labels = "/home/sakuni/phd/objective2/dataset/real_folds/fold4/labels/val/*.txt"
    pred_path = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold4/labels"
    safe_pred_path = "/home/sakuni/phd/dataset_paper/final_collection25-2/lc4/results/wardHistAdj/detect/safe_lc4_wardHistAdj_001_4/labels/*.txt"
    save_dir = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold4"
    mainOnly(path_labels, pred_path, save_dir)
    mainSafe(path_labels, pred_path, safe_pred_path, save_dir)

    path_labels = "/home/sakuni/phd/objective2/dataset/real_folds/fold5/labels/val/*.txt"
    pred_path = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold5/labels"
    safe_pred_path = "/home/sakuni/phd/dataset_paper/final_collection25-2/lc4/results/wardHistAdj/detect/safe_lc4_wardHistAdj_001_5/labels/*.txt"
    save_dir = "/home/sakuni/phd/results/p2/test/all/80_real/80_real_80_synth/r4_5_80_real_80_synth_fold5"
    mainOnly(path_labels, pred_path, save_dir)
    mainSafe(path_labels, pred_path, safe_pred_path, save_dir)