    ...
    with open(txt_path) as f:
        for cnt, line in enumerate(f):
            ...
            if h>w:
                ...
                avg_small = np.average(img[startY:endY,anno_startX:anno_endX])
                ...
                avg_small = np.average(img[anno_startY:anno_endY,startX:endX])
                num_big_pix = (endX-startX)*(endY-startY)
...
with open("avg+10.csv", mode='w') as csv_file:
