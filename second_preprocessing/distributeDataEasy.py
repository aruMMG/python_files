...
# image_path_hard = "/home/sakuni/phd/dataset_paper/final_collection25-2/lc1/tonemaped/reinhard_gamma_CC/1024/split/images_hard"
...
dirs = os.listdir(image_path_easy)
shuffle(dirs)
j=0
i=0
for num in dirs:
